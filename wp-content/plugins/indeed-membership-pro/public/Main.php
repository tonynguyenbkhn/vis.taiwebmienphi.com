...
function ihc_public_head(){
	...
	wp_enqueue_style( 'ihc_front_end_style', IHC_URL . 'assets/css/style.min.css', [], '13.5' );

	wp_enqueue_style( 'ihc_templates_style', IHC_URL . 'assets/css/templates.min.css', [], '13.5' );

	wp_enqueue_script( 'jquery' );

	wp_enqueue_script( 'ihc-front_end_js', IHC_URL . 'assets/js/functions.min.js', ['jquery'], '13.5' );
	...
	wp_register_style( 'ihc_iziModal', IHC_URL . 'assets/css/iziModal.min.css', [], '13.5' );
	wp_register_script( 'ihc_iziModal_js', IHC_URL . 'assets/js/iziModal.min.js', ['jquery'], '13.5' );
	...
	if ( !isset( $GLOBALS['wp_scripts']->registered['ihc-public-dynamic'] ) ){
			wp_register_script( 'ihc-public-dynamic', IHC_URL . 'assets/js/public.js', ['jquery'], '13.5' );
	}
}
