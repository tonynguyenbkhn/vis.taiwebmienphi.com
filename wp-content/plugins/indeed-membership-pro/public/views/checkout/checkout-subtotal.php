...
// maybe prorating
if ( isset( $data['preparePaymentData']['prorate_from'] ) ){
    $sessionAttr['prorate_from'] = $data['preparePaymentData']['prorate_from'];
}
if ( isset( $data['preparePaymentData']['prorate_expire_time'] ) ){
    $sessionAttr['prorate_expire_time'] = $data['preparePaymentData']['prorate_expire_time'];
}
// end of prorating

?>
    <div class="ihc-js-checkout-session" data-value="<?php
      echo base64_encode(json_encode( $sessionAttr ));?>" ></div>
