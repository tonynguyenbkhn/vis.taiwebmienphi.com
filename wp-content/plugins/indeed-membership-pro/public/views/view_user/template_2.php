	...
	<?php if (!empty($data['custom_fields'])):?>
		<div class="iump-user-fields-list">
			<?php foreach ($data['custom_fields'] as $label => $value):?>
				<?php if ($value!=''):?>
                    <div class="iump-user-field"><div class="iump-label"><?php echo esc_html(stripslashes($label)); ?></div> <div class="iump-value"> <?php echo esc_ump_content($value);?> </div><div class="ihc-clear"></div></div>
