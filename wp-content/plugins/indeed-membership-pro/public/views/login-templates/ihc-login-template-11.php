  ...
  <div class="<?php echo esc_attr( $wrappClass );?> <?php echo esc_attr($template);?>">
      <form method="post" id="<?php echo esc_attr($formId);?>">
          ...
          <div class="impu-remember-wrapper">
              ...
              <span class="impu-form-label-remember"><?php echo esc_html__('Remember Me');?></span>
          </div>
          <?php endif;?>
          <!-- End of remember me --->
          ...
          <?php if ( !empty( $settings['ihc_login_register'] ) ):?>
              <div class="impu-form-links">
                <div class="impu-form-links-reg"><?php echo esc_html__("Don't have an account?", 'ihc');?> <a href="<?php echo esc_url($registerPageUrl);?>"><?php echo esc_html__('Register', 'ihc');?></a></div>
              </div>
              <?php endif;?>
          <!-- End of Aditional links -->
