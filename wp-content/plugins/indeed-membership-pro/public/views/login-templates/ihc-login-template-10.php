      ...
      <form method="post" id="<?php echo esc_attr($formId);?>">
          ...
          <?php if ( !empty( $settings['ihc_login_register'] ) ):?>
              <div class="impu-form-links">
                <div class="impu-form-links-reg"><?php echo esc_html__("Don't have an account?", 'ihc');?> <a href="<?php echo esc_url($registerPageUrl);?>"><?php echo esc_html__('Sign Up', 'ihc');?></a></div>
              </div>
              <?php endif;?>
