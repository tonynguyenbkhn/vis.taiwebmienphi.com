...
class CropImage
{
    ...
    public function saveImage($filesData=array())
    {
            ...
            file_put_contents( IHC_PATH . 'log.log', 'save image \n', FILE_APPEND );
            file_put_contents( IHC_PATH . 'log.log', 'files data ' . json_encode( $filesData ), FILE_APPEND );
    ...
    {
          file_put_contents( IHC_PATH . 'log.log', 'start \n', FILE_APPEND );
          file_put_contents( IHC_PATH . 'log.log', 'post data ' . json_encode( $postData ), FILE_APPEND );
