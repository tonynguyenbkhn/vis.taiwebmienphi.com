	...
	<?php endif; ?>
		...
		<?php if ($is_uap_active):?>
				...
				if (empty($_GET['subtab']) || sanitize_text_field($_GET['subtab'])=='list'):
					...
					wp_enqueue_script( 'ihcmultiselectfunctions', IHC_URL . 'admin/assets/js/jquery.multiselect.js', ['jquery'], '13.5' );
					...
					wp_enqueue_script( 'ihcdatabsescrolltop', IHC_URL . 'admin/assets/js/datatables/dataTables.scrollToTop.min.js', ['jquery'], '13.5' );
					// iump datatable functions
				  wp_register_script( 'ihc-table', IHC_URL . 'admin/assets/js/table.js', ['jquery'], '13.5' );
					// setting up the variables
					global $wp_version;
					$pageState = get_option( 'ihc_datatable_state_for-affiliates', false );
					if ( $pageState ){
					...
					if ( version_compare ( $wp_version , '5.7', '>=' ) ){
							...
							wp_add_inline_script( 'ihc-table', "iump_datatable_type", $tableDataType );
							wp_add_inline_script( 'ihc-table', "iump_datatable_state", $pageState );
					}
